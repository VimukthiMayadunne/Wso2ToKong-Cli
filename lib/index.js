...
var swagger, apiYaml, url, host, ans, seviceID;
                    ...
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 4:
                                    seviceID = _a.sent();
                                    return [4 /*yield*/, readFile.readApiYaml()];
                                case 5:
                                    apiYaml = _a.sent();
                                    return [4 /*yield*/, readFile.addPlugins(apiYaml, seviceID)];
                                case 6:
                                    _a.sent();
                                    console.log("Service Created");
                                    console.log("Service ID   :", data.id);
                                    console.log("Service Name :", data.name);
                                    return [4 /*yield*/, createRoute(url, swagger.info.title)];
                                case 7:
                                    _a.sent();
...
function createPluginApiKey(serviceID, name) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new ApiKey({
                        service: { id: seviceID },
